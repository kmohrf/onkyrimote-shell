...
from onkyrimote_shell import __version__
...
setup(
    name="onkyrimote-shell",
    version=__version__,
    description="onkyrimote-based serial protocol and shell",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://git.hack-hro.de/kmohrf/onkyrimote-shell",
